          ...
          <>
              ...
              >
                ...
                {/* <div className='d-flex align-items-center flex-grow-1 flex-lg-grow-0'>
                  <Link to='/dashboard' className='d-lg-none'>
                      <img
                        alt='Logo'
                        src={toAbsoluteUrl('media/logos/LOGO_Emac.png')}
                        className='h-30px'
                      />
                  </Link>
                </div> */}
            ...
            <Link to='/dashboard' className='d-flex align-items-center'>
                 <img
                    alt='Logo'
                    src={toAbsoluteUrl('media/logos/LOGO_Emac.png')}
                    className='h-50px h-lg-50px app-sidebar-logo-default theme-light-show'
                  />
            <h3 className='text-light ms-5'>ສູນວິຊາການດ້ານການຈັດການສິ່ງແວດລ້ອມ</h3>
            </Link>
